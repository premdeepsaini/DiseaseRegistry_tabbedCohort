...
angular.module('DiseaseRegistry.controllers', ['DiseaseRegistry.services', 'rzModule', 'angularjs-dropdown-multiselect', 'chart.js','ng-fusioncharts'])
...
//////////////////////////////////Disease Filter Ends///////////////////////////////////////////////////////////
    ...
    .controller('GraphCtrl', function ($scope, $http, $ionicLoading) {
        ...
        $scope.getGraphClick = function () {
            ...
            $http.post("http://127.0.0.1:3000/api/Disease", diseaseJSON).then(function (response) {

                $scope.showLoading();

                $http.post("http://127.0.0.1:3000/api/Graph", response.data).then(function (response) {
                    ...
                    temp1.forEach(function (obj) {
                        ...
                        $scope.dataSource.data.push({label: obj._id.City,value: obj.CityCount});
                        $scope.barData[0].push(obj.CityCount);


                        $scope.barLabel.push(obj._id.City);
